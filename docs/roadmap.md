...
| 6. Minimal Auth UI          | Done        | Add Bejamas-derived form components, Lucide Astro icons, login/register/reset/verify pages, and dashboard shell.                  | `npm run check`, `npm run build`, user visual verification                      |
