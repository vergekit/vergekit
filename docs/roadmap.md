...
| 5. Form And API Conventions | Not started | Add Zod parsing helpers, standard JSON responses, Astro Actions patterns, and one sample mutation.                                | `npm run test -- tests/http tests/actions`, `npm run check`                     |
